<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Pages/Principal.Master" CodeBehind="EditarUsuario.aspx.vb" Inherits="Web.EditarUsuario" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(function () {
            ...
            $("#MainContent_btnDialogo").click(function () {
                ...
                <td style="width: 40%;">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtEdad" class="form-control disabled" runat="server" meta:resourcekey="txtEdadResource1"></asp:TextBox>
                                &nbsp;
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                ...
                                <asp:Button ID="btnDialogo" class="btn btn-primary" runat="server" Text="Boton" meta:resourcekey="btnDialogoResource1" />
                                <asp:Button ID="btnBorrar" runat="server" Text="Button" style = "display:none" />
                            </td>
                        </tr>
                    </table>
                </td>
